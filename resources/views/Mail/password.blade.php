                                    ...
                                    <tr>
                                        <td class="esd-container-frame" width="560" valign="top" align="center">
                                            <table style="background-position: left top;" width="100%" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    <tr>
                                                        <td class="esd-block-image es-p5t es-p5b es-m-txt-c" align="center" style="font-size:0">
                                                            <a target="_blank"><img src="https://tlr.stripocdn.email/content/guids/CABINET_dd354a98a803b60e2f0411e893c82f56/images/23891556799905703.png" alt style="display: block;" width="175"></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="esd-block-text es-p15t es-p15b" align="center">
                                                            <h1 style="color: #333333; font-size: 20px;"><strong style="background-color: transparent;">ESQUECEU SUA <br>SENHA?</strong></h1>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="esd-block-text es-p40r es-p40l" align="left">
                                                            <p style="text-align: center;">&nbsp;Olá {{ $user->name }}!</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="esd-block-text es-p35r es-p40l" align="left">
                                                            <p style="text-align: center;">Esta é uma requisção de renovação de Senha!</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" class="esd-block-text">
                                                            <p style="font-size: 27px; color: #0000cd;"><strong>{{$senha}}</strong></p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
